...
export function PropertiesSidebar({ properties, selectedId, loading, totalCount, onSelect, className }: PropertiesSidebarProps) {
    ...
    return (
        <div
            className={cn(
                "z-10 flex min-h-0 w-full flex-col border-b border-gray-200 bg-white lg:h-full lg:w-72 lg:shrink-0 lg:border-r lg:border-b-0 dark:border-gray-800 dark:bg-gray-900",
                className,
            )}
        >
            <div className="border-b border-gray-200 p-3 dark:border-gray-800">
                <span className="text-xs font-medium tracking-wider text-gray-500 uppercase dark:text-gray-400">
                    {loading ? "Loading..." : `${formatNumber(totalCount)} Results · Showing ${formatNumber(showingCount)}`}
                </span>
            </div>
